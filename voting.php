...
if (mysqli_num_rows($result2) < 1) {
    ...
    echo "<div class='container'><div class='official-election-text'>The voter is not verified. You can't proceed.</div></div>";
} else {
    ...
    } else if (strtotime($currentDateTime) > strtotime($eventInfo['event_datetimestart'] ?? '')) {
    echo "<div class='official-election-text'>Election Event has Not Yet Started.</div>";
}

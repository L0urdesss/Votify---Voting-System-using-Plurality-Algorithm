...
<?php
  if ($count < 1) {
        ?><br><br><br><br><br>
<?php
      echo '<h1>No Election Yet</h1>';
  } else if (strtotime($currentDateTime) < strtotime($eventInfo['event_datetimeend'])) {
        ?><br><br><br><br><br>
<?php
    echo '<h1>The election event is ongoing.</h1>';
    // You can set a flag or perform any other action indicating that the event has ended
} else {
?>  
...
<?php
     echo '<h1>' . $eventInfo['event_name'] . ' <br><br> ' . 
        'Start Date: '.$eventInfo['event_datetimestart'] . ' <br>' .
        'End Date: '. $eventInfo['event_datetimeend'] . '</h1>';
